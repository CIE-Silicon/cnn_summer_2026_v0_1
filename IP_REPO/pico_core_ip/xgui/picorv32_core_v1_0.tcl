...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "ENABLE_DSQ" -parent ${Page_0}
...
proc update_PARAM_VALUE.ENABLE_DSQ { PARAM_VALUE.ENABLE_DSQ } {
	# Procedure called to update ENABLE_DSQ when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.ENABLE_DSQ { PARAM_VALUE.ENABLE_DSQ } {
	# Procedure called to validate ENABLE_DSQ
	return true
}
...
proc update_MODELPARAM_VALUE.ENABLE_DSQ { MODELPARAM_VALUE.ENABLE_DSQ PARAM_VALUE.ENABLE_DSQ } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.ENABLE_DSQ}] ${MODELPARAM_VALUE.ENABLE_DSQ}
}
